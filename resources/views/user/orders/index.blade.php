    ...
    @if($orders->isEmpty())
        <div class="card border-0 shadow-sm p-16 text-center bg-white relative overflow-hidden">
            <div class="relative z-10">
                ...
                <a href="{{ route('books.index') }}" class="inline-block px-12 py-5 bg-primary text-white font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl shadow-xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all">Start Shopping</a>
            </div>
