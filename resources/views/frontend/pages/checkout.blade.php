                ...
                <div class="w-full lg:w-2/3 space-y-10">
                    <div class="bg-white rounded-[40px] shadow-xl shadow-slate-200/50 border border-slate-100 p-10 lg:p-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                <label for="phone" class="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Phone Number</label>
                            ...
                            <div class="space-y-2">
                                <label for="city" class="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">City / Region</label>
                            ...
                            <div class="col-span-full space-y-2">
                                <label for="shipping_address" class="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Full Delivery Address</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        citySelect.addEventListener('change', function() {
            let charge = this.value === 'Dhaka' ? 80 : 110;
